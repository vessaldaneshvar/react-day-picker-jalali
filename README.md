...
```shell
npm install react-day-picker-jalali date-fns-jalali  # using npm
pnpm install react-day-picker-jalali date-fns-jalali # using pnpm
yarn add react-day-picker-jalali date-fns-jalali     # using yarn
```
